    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('images/logo/logo-jat.jpg')}}" alt="Logo" srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->is('admin/kategori*') ? 'active' : '' }}">
                    <a href="{{ URL::to('admin/kategori')}}" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ request()->is('admin/produk*') ? 'active' : '' }}">
                    <a href="{{ URL::to('admin/produk')}}" class='sidebar-link'>
